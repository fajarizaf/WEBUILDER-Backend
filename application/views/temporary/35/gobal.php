<section class="scrat" element="section" resizelayout="false">      <br>
        
        
          
         <div type="title" element="content" style="cursor: text; padding: 0px; left: 394px; top: 3px; position: absolute; width: 521px; height: 80px; border: none; background: none;" mode="edit" class="columnFull ui-draggable ui-resizable ui-draggable-disabled ui-state-disabled" resize="false" init="5" aria-disabled="true" font="font6" contenteditable="true"><a href="#"><h2 style="font-size: 26px; color: rgb(116, 66, 16);" font="font6">Tekhnologi web terbaru saat ini yang mempengaruhi masa yang akan</h2></a></div>
   

   <div type="text" element="content" style="cursor: default; padding: 0px; left: 30px; top: 78px; position: relative; width: 90%; height: 70px; border: none; background: none 0% 0% repeat scroll transparent;" mode="edit" class="columnFull ui-draggable ui-resizable ui-draggable-disabled ui-state-disabled" resize="false" init="6" aria-disabled="true">This is a great space to write long text about your company and your services. You can use this space to go into a little more detail about your company. Talk about your team and what services you provide. Tell your visitors the story of how you came up with the idea for your business and what makes you different from your competitors. Make your company stand out and show your visitors who you are.</div>



	

<div type="text" element="content" style="cursor: default; padding: 0px; left: 30px; top: 59px; position: relative; width: 852px; height: 400px; border: none;" mode="edit" class="columnFull ui-resizable ui-draggable ui-draggable-disabled ui-state-disabled" resize="false" init="4" aria-disabled="true">
